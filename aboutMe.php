...
<html>
	<head>
		<title>About Me | Ferri de Lange</title>
		<meta charset="utf-8" />
				...
				<section id="main">
					...
					<!-- Section -->
						<section>
							<div class="inner">
								<header>
									<h1> Ferri de Lange | Gameplay developer</h1>
								</header>
								...
								<section class="columns double" style="width: 75%">
									...
									<div class="column">
										<div class="slideshow">
											<img src="images/fulls/1.jpg" class="slide">
											<img src="images/fulls/2.jpg" class="slide">
											<img src="images/fulls/3.jpg" class="slide">
											<br>
											<a onclick="PreviousImage()" class="button">Previous</a>
											<a onclick="NextImage()" 	 class="button">Next</a>
										</div>
									</div>
								</section>
							</div>
